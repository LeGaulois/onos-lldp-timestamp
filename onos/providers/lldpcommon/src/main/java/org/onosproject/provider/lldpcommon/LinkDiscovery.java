 ...
 */
 ...
 /*
 FLO
 ADD TO onos/providers/lldpcommon/src/main/java/org/onosproject/provider/lldpcommon/
 */
...
public class LinkDiscovery implements TimerTask {
    ...
    public boolean handleLldp(PacketContext packetContext) {
        ...
        Timestamp lldp_timestamp = onoslldp.getTimestampTLV();
        long current_ts_nano = (current_timestamp.getTime());
        long lldp_ts_nano = (lldp_timestamp.getTime());
        ...
        if (onoslldp != null) {
            ...
            if (!isNullOrEmpty(idString)) {
                ...
                LinkDescription ld = new DefaultLinkDescription(src, dst, lt, delay);
